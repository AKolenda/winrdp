# Release preparation validation — 2026-09-11

The 0.7.4 candidate contains the current simple/full launcher, native session
controls, and connection/clipboard patches. This records actual checks rather
than treating compilation as a live protocol test.
...
| Packaging recovery | 15 Python tests passed; version metadata consistent at 0.7.4. |
| Builds | Launcher and standalone session release builds passed with locked dependency resolution. |
...
| Website | Desktop 1440 px and mobile 390 px layout checks passed; no overflow or console errors; image loaded; downloads point to GitHub Releases. Production HTTPS returned 200. |

## Limits before a stable binary release
